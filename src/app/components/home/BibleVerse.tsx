...
export default function YoutubeSection() {
  return (
    <section className="py-16 bg-alabaster border-b border-[#AE8F05]/15">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center gap-6 justify-between max-w-4xl mx-auto">
          <div className="flex-shrink-0 relative">
            <div className="absolute inset-0 bg-gradient-to-tr from-[#AE8F05]/20 to-[#F7E7CE]/40 rounded-full blur-2xl transform scale-100"></div>
            <img 
          ...
          <div className="flex-1 text-center md:text-left space-y-5">
            ...
            <h2 className="text-2xl md:text-4xl font-serif font-bold text-warm-slate tracking-tight">
              7 Spirits Tv
            </h2>
            <p className="text-base md:text-lg text-[#5C5854] leading-relaxed max-w-2xl">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
              <a 
                ...
                className="inline-flex items-center justify-center px-6 py-3 bg-[#ff0000] hover:bg-[#cc0000] text-white font-bold rounded-xl transition-all shadow-md shadow-[#ff0000]/20 hover:scale-105"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center px-6 py-3 bg-transparent border-2 border-[#AE8F05]/40 hover:border-[#AE8F05] text-warm-slate font-bold rounded-xl transition-all hover:scale-105"
              >
                Watch Latest Videos
              </a>
            </div>
