      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        ...
        <div className="space-y-12">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl font-extrabold text-warm-slate tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {MAIN_LEADERS.map((leader, idx) => (
              <div key={idx} className="group bg-white rounded-2xl p-6 border border-[#AE8F05]/20 shadow-lg hover:shadow-xl hover:border-[#D4AF37] transition-all duration-500 text-center">
                <div className="w-28 h-28 rounded-full overflow-hidden mx-auto mb-4 border-2 border-[#D4AF37] shadow-lg">
                  <ImageWithFallback
                    src={leader.photoUrl}
                    alt={leader.nameEn}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="prose text-[#5C5854] text-base leading-relaxed">
                  ...
                  <p>In 2010, the college reorganized its educational structure and upgraded its academic system to a college-level program. With a strong focus on maintaining educational quality, it continued accepting and training students. From 2010 to 2015, the college trained and graduated an additional <strong>100 ministers</strong>.</p>
                  <p>From 2016 to 2018, the college provided various short-term courses. In 2019, Wisdom Bible College began reorganizing itself once again and developing a stronger educational system.</p>

                  <h4 className="font-bold text-warm-slate mt-6 mb-2">College Address</h4>
                  <p className="bg-alabaster p-4 rounded-xl text-sm border border-gray-100">
                  ...
                  <div className="mt-6 flex items-center space-x-4 bg-[#F7E7CE]/30 p-4 rounded-xl border border-[#AE8F05]/20">
          ...
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-xl border border-[#AE8F05]/20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="prose text-[#5C5854] text-base leading-relaxed">
                  <p>The Nekemte Afan Oromo Bible College is well underway and preparing for its future mission. It is currently in the process of completing a massive <strong>5-story building</strong>, which has now reached the 4th floor of construction.</p>
                  <p>While the college has not officially begun operations yet, anticipation is high. It is believed that by the end of 2019, the building will be fully inaugurated and the college will officially open its doors to students.</p>

                  <div className="mt-8 flex items-center space-x-4 bg-[#F7E7CE]/30 p-4 rounded-xl border border-[#AE8F05]/20">
